...
API_KEY = 'ebb7ce188ae7490a936cde1a3732a6fe'
...
def search_recipes(query):
    ...
    print("Request URL:", response.url)  # ✅ See the exact URL
    print("Status Code:", response.status_code)  # ✅ See if request succeeded
